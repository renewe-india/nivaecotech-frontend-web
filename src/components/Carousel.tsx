          ...
          {loading ? ( // Conditional rendering based on loading state
            ...
            <>
              ...
              <div className="flex gap-4 mt-4">
                <button
                  className="bg-[#2e7134] hover:bg-[#193d1c] rounded-xl text-white uppercase px-4 py-3 my-2 lg:my-10"
                  onClick={gotoAbout}
                >
                  Read More
                </button>
                <button
                  className="bg-[#bf7034] hover:bg-[#8c5226] rounded-xl text-white uppercase px-4 py-3 my-2 lg:my-10"
                  onClick={gotoContact}
                >
                  Consult
                </button>
